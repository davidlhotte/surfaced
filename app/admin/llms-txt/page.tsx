...
/**
 * llms.txt page has been consolidated into Settings > Technical SEO
 * This page redirects users to the Settings page
 */
export default function LlmsTxtRedirectPage() {
          ...
          <Card>
            <BlockStack gap="400" inlineAlign="center">
              ...
              <Text as="p" alignment="center">
                llms.txt configuration has moved to Settings &gt; Technical SEO
              </Text>
